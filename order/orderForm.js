const html = `<div class="container" id="orderFormDialog" style="padding-top:20px;padding-bottom:100px">
    <div class="row">
        <div class="col-md-12">
            <div class="needs-validation" novalidate>
                <div class="row">
                    <div class="col-md-9 mb-3">
                        ...
                        <input type="text" readonly id="orderDate" class="form-control" name="order-date"
                            placeholder="订单日期">
                    </div>
                    <div class="col-md-3 mb-3">
                        <label for="country">是否付款</label>
                        <select class="custom-select d-block w-100" name="order-paid">
                ...
                <div id="cardContainer">
                    <div class="card mb-4" style="background: #f9f9f9;">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <button class="btn btn-sm btn-danger float-right del-hook">删除</button>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="order-income" placeholder="进项"
                                        value="">
                                </div>
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="order-extra" placeholder="杂费"
                                        value="">
                                </div>
                            </div>
                            <div class="mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="order-bankCharges" placeholder="银行手续费"
                                value="">
                        </div>
                        <div class="col-md-6 mb-3">
                ...
                <div class="row">
                        <div class="col-md-6 mb-3" id="abExpressSelecter">
                            <label for="username">国外快递公司</label>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="username">国外快递单号</label>
                            <div class="input-group">
                                <input type="text" class="form-control" name="order-abExpressNum" placeholder="快递单号">
                            </div>
                        </div>
                    </div>
                <div class="row">
                    <div class="col-md-6 mb-3" id="expressSelecter">
                        <label for="username">国内快递公司</label>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="username">国内快递单号</label>
                        <div class="input-group">
                            <input type="text" class="form-control" name="order-expressNum" placeholder="快递单号">
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="username">国内快递日期</label>
                        <div class="input-group">
                            <input type="text" id="orderExpressDate" readonly class="form-control"
                                name="order-expressDate" placeholder="请选择">
                        </div>
                    </div>
                </div>
                <div class="row">
